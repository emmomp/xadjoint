...
adj_dict = \
{
    ...
    'ADJsst':
         {'adjtype':'ADJ',
          ...
          'vartype':'c',
          'ndims':2,
          'attrs':{'long_name':'Sensitivity to Surface Potential Temperature','units':'[J]/Degree C'},
          'fact':0.3,
          },
...
#          'vartype':['j','i_g'],
     ...
     'adxx_theta':
         {'adjtype':'adxx',
          ...
          'vartype':'c',
          'ndims':3,
          'attrs':{'long_name':'Sensitivity to Initial Potential Temperature','units':'[J]/Degree C'},
          'fact':1.6,
          }     
